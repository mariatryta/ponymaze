<template>
  <main class="h-90v">
    ...
    >
      <Legend class="lg:w-2/12 lg:mr-8 w-full mb-10 flex-1"></Legend>
      <MazeGrid
        class="max-w-full w-full lg:w-9/12 md:h-full flex flex-col md:items-center mb-10 md:mb-0 justify-center"
